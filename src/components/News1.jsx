...
export class News extends Component {
    ...
    render() {
        return (
            <>
                <h1 className="text-center d-flex align-items-center justify-content-center" >NewsMonkey - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
                ...
                > 
                    ...
                    <div className="row">
                        {this.state.articles.map((element) => {
                            return <div className="col-md-3 d-flex flex-wrap " key={element.url}>
